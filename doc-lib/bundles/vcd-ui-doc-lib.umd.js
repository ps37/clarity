(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ...
      : ((global = global || self),
        factory(
          ((global.vcd = global.vcd || {}), (global.vcd['ui-doc-lib'] = {})),
          global.ng.core,
          global.ng.router,
          global.Prism,
          null,
...
})(this, function(exports, core, router, Prism, prismTypescript, prismScss, angular, common) {
  'use strict';
  ...
  var DocumentationContainerComponent = /** @class */ (function() {
    ...
    DocumentationContainerComponent.ctorParameters = function() {
      return [{ type: router.ActivatedRoute }];
    };
  ...
  var HighlightService = /** @class */ (function() {
    ...
    HighlightService.decorators = [{ type: core.Injectable, args: [{ providedIn: 'root' }] }];
    /** @nocollapse */ HighlightService.ngInjectableDef = core.ɵɵdefineInjectable({
  ...
  var PrismHighlightService = /** @class */ (function(_super) {
    ...
    PrismHighlightService.decorators = [{ type: core.Injectable }];
  ...
  StackBlitzWriterService = /** @class */ (function() {
     ...
     */ = function(entry) {
      ...
      /** @type {?} */
      var exampleModule = this.docRetriever.getModule(
  ...
  var ExampleViewerComponent = /** @class */ (function() {
    ...
    ExampleViewerComponent.propDecorators = {
      ...
      exampleContainer: [
        { type: core.ViewChild, args: ['exampleContainer', { static: true, read: core.ViewContainerRef }] },
      ],
    };
   ...
   * @type {?}
   */
  var DOCUMENTATION_DATA = new core.InjectionToken('DocLibModule.forRoot() CompoDocRetrieverService doc jsons.');
  /**
   * Token that makes Stqckblitz JSON data available to factory functions
   * @type {?}
   */
  var STACKBLITZ_DATA = new core.InjectionToken('DocLibModule.forRoot() StackBlitz template JSON data');
  /**
  ...
  exports.DOCUMENTATION_DATA = DOCUMENTATION_DATA;
  ...
  exports.STACKBLITZ_DATA = STACKBLITZ_DATA;
  exports.SourceCodeViewerComponent = SourceCodeViewerComponent;
  exports.StackBlitzWriterService = StackBlitzWriterService;
  exports.getCompoDocRetrieverService = getCompoDocRetrieverService;
  exports.getStackBlitzWriter = getStackBlitzWriter;
  exports.ɵa = CompoDocRetrieverService;
  exports.ɵb = DocumentationContainerModule;
  exports.ɵc = OverviewViewerModule;
  exports.ɵd = OverviewViewerComponent;
  exports.ɵe = ApiViewerModule;
  exports.ɵf = ApiViewerComponent;
  exports.ɵg = ExampleViewerModule;
  exports.ɵh = SourceCodeViewerModule;
  exports.ɵi = SourceCodeViewerComponent;
  exports.ɵj = HighlightService;
  exports.ɵk = ExampleViewerComponent;
  exports.ɵl = DocumentationContainerComponent;
  exports.ɵm = PrismHighlightService;
